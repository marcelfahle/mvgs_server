defmodule MvgsServer.AccountsTest do
  use MvgsServer.DataCase

  alias MvgsServer.Accounts

  describe "users" do
    alias MvgsServer.Accounts.User
  ...
  describe "credentials" do
    ...
    @valid_attrs %{email: "test@test.com", password_hash: "some password_hash"}
    ...
    test "create_credential/1 with valid data creates a credential" do
      ...
      assert credential.email == "test@test.com"
